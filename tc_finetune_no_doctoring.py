...
# chop off last layer: python tc_finetune_no_doctoring.py .3 120 256 .0001 0 True './models/ilsvrc2012.ckpt'
# don't chop off last layer: python tc_finetune_no_doctoring.py .3 120 256 .0001 0 False './models/ilsvrc2012.ckpt'
"""
