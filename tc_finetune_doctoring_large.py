...
# chop off last layer: python tc_finetune_doctoring_large.py .3 40 256 .0001 3 True './models/ilsvrc.ckpt'
# don't chop off last layer: python tc_finetune_doctoring_large.py .3 40 256 .0001 3 False './models/ilsvrc.ckpt'
"""
...
def main(margin,batch_size,output_size,learning_rate,whichGPU,is_finetuning,pretrained_net):
    ...
    ckpt_dir = './output/doctoring_large/ckpts'
    log_dir = './output/doctoring_large/logs'
    train_filename = './input/train.txt'
