"""
# ilsvrc: python evaluate/eval_resnet_feats_counts.py 0 ./models/ilsvrc2012.ckpt
# expedia: python evaluate/eval_resnet_feats_counts.py 0 ./output/expedia/ckpts/checkpoint-2018_09_19_1314_lr0pt0001_outputSz256_margin0pt3-74157
# no doctoring: python evaluate/eval_resnet_feats_counts.py 0 ./output/no_doctoring/ckpts/checkpoint-2018_09_19_0913_lr0pt0001_outputSz256_margin0pt3-75721
# doctoring: python evaluate/eval_resnet_feats_counts.py 0 ./output/doctoring/ckpts/checkpoint-2018_08_28_2136_tcam_with_doctoring_lr0pt0001_outputSz256_margin0pt3-70841
# chain: python evaluate/eval_resnet_feats_counts.py 0 ./output/sameChain/no_doctoring/ckpts/checkpoint-2018_09_30_0809_lr1e-05_outputSz256_margin0pt4-29999
# chain doctoring: python evaluate/eval_resnet_feats_counts.py 0 ./output/sameChain/doctoring/ckpts/checkpoint-2018_09_30_0854_lr0pt0001_outputSz256_margin0pt4-29999
"""
...
def main(pretrained_net,whichGPU):
    ...
    for test_dataset, test_name in zip(test_datasets,test_names):
        ...
        save_h5('average_retrieval_count',average_accuracy,'f',os.path.join(test_output_dir,'average_retrieval_count.h5'))
