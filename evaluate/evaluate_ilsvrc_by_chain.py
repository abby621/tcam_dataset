...
train_dataset = './input/train_by_chain.txt'
...
chain_datasets = ['./input/test_by_chain.txt','./input/occluded_test/by_chain/0.txt','./input/occluded_test/by_chain/1.txt','./input/occluded_test/by_chain/2.txt','./input/occluded_test/by_chain/3.txt']
chain_test_names = ['by_chain','by_chain_occluded0','by_chain_occluded1','by_chain_occluded2','by_chain_occluded3']
for test_dataset, test_name in zip(chain_datasets,chain_test_names):
    ...
    save_h5('test_chain_classes',test_classes,'i8',os.path.join(test_output_dir,'testChainClasses.h5'))
    ...
    print 'By chain: ', test_output_dir
